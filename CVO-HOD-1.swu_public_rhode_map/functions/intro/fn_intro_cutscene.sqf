...
[
    ...
    ,["CODE", { disableUserInput true; }] // ToDo: Audio Fade to 0
    ...
    ,["DELAY", 3]
    ,["RAVEN", 15]
    ,[ "CODE", { while {userInputDisabled} do {disableUserInput false;}; }] // ToDo: intro_truck_start
    ,["DELAY", 3]
    ,[ "CODE", { while {userInputDisabled} do {disableUserInput false;}; }] // ToDo: Audio Fade Into the game
