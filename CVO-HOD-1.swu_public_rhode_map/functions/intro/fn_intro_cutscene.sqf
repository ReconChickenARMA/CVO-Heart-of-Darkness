...
[
    ...
    ,[ "Text", "1974<br/><br/><br/>As its colonial government of <t color='#ffffff'>collapsed</t>..." ]
    ...
    ,[ "Text", "while others prefer to keep their involvement <t color='#ffffff'>in the shadows</t>" ]
    ,[ "Text", "Your are a group of east german <t color='#ffffff'>mercenaries</t>..." ]
    ,[ "Text", "Contracted by the <t color='#ffffff'>German Democratic Republic</t>" ]
    ,[ "Text", "Their Goal: support the <t color='#ffffff'>People's Union of Bocano</t>." ]
    ...
    ,[ "Text", "A small <t color='#ffffff'>church</t> in lone valley..." ]
